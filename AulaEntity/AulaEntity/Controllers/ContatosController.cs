...
namespace AulaEntity.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public ContatosController(AulaEntityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contato != null ? 
                          ...
                          Problem("Entity set 'AulaEntityContext.Contato'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AulaEntityContext.Contato'  is null.");
            }
            var contato = await _context.Contato.FindAsync(id);
            if (contato != null)
            {
