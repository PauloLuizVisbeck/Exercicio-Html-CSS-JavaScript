...
namespace AulaEntity.Controllers
{
    public class LocaisController : Controller
    {
        ...
        public LocaisController(AulaEntityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Local != null ? 
                          ...
                          Problem("Entity set 'AulaEntityContext.Local'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Rua,Numero,Bairro,Cidade")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Rua,Numero,Bairro,Cidade")] Local local)
        {
            if (id != local.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AulaEntityContext.Local'  is null.");
            }
            var local = await _context.Local.FindAsync(id);
            if (local != null)
            {
